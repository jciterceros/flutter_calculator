        ...
        children: <Widget>[
          ButtonRow([
            Button(
              buttonText: "AC",
              bigButton: true,
              color: Button.darkGray,
              cb: cb,
            ),
            Button(buttonText: "mod", color: Button.darkGray, cb: cb),
            Button(buttonText: "/", color: Button.orangeOperator, cb: cb),
          ]),
          SizedBox(height: 1),
          ButtonRow([
            ...
            Button(buttonText: "x", color: Button.orangeOperator, cb: cb),
          ]),
          SizedBox(height: 1),
          ButtonRow([
